...
both ways from the same run — [prose](../worked-example/reports/vm-cow-01/report.md),
[structured](../worked-example/reports/vm-cow-01/report.json) — and reading them side
